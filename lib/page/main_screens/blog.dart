          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                  padding:
                      EdgeInsets.only(top: 15.0, left: 0, right: 0, bottom: 0),
                  itemCount:
                      state.all_blogs == null ? 0 : state.all_blogs.length,
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => WebViewExample(
                                url: state.all_blogs[index].link,
                              ),
                            ));
                      },
                      child: Padding(
