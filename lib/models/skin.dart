class Skin {
  ...
  Skin(
      {this.userId, this.reapply, this.recommended_timing, this.spf, this.sun_radiation, this.uv_level, this.skintype,this.city,this.cancer_risk,this.skincolor,this.date,this.time});
